...
open class SSLSecurity : NSObject {
     ...
     */
    open func isValid(_ trust: SecTrustRef, domain: String?) -> Bool {
     ...
     */
    func extractPublicKey(_ data: Data) -> SecKeyRef? {
    ...
    /**
     ...
     - returns: a public key
     */
    func extractPublicKeyFromCert(_ cert: SecCertificate, policy: SecPolicy) -> SecKeyRef? {
     ...
     */
    func certificateChainForTrust(_ trust: SecTrustRef) -> [Data] {
     ...
     */
    @nonobjc func publicKeyChainForTrust(_ trust: SecTrustRef) -> [SecKeyRef] {
